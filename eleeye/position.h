...
const int64_t UNKNOWN_BITPIECE = (1 << UNKNOWN_FROM) | (1 << (UNKNOWN_FROM + 1)) | (1 << (UNKNOWN_FROM + 2)) | (1 << (UNKNOWN_FROM + 3)) | (1 << (UNKNOWN_FROM + 4)) | (1 << (UNKNOWN_FROM + 5)) | (1 << (UNKNOWN_FROM + 6)) | (1 << (UNKNOWN_FROM + 7)) | (1 << (UNKNOWN_FROM + 8)) | (1 << (UNKNOWN_FROM + 9)) | (1 << (UNKNOWN_FROM + 10)) | (1 << (UNKNOWN_FROM + 11)) | (1 << (UNKNOWN_FROM + 12)) | (1 << (UNKNOWN_FROM + 13)) | (1 << UNKNOWN_TO);
const int64_t ATTACK_BITPIECE = KNIGHT_BITPIECE | ROOK_BITPIECE | CANNON_BITPIECE | PAWN_BITPIECE | ADVISOR_BITPIECE | BISHOP_BITPIECE | UNKNOWN_BITPIECE;
